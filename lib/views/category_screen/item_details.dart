...
children: [
  Row(children: [
    ...
    Row(
      children: List.generate(3, (index) => VxBox().size(40, 40).roundedFull.color(Vx.randomPrimaryColor).
  ...
  Row(
          ...
          "\$0.00".text.color(redColor).size(16).fontFamily(bold).make()
                  ...
                  10.heightBox,
                  "This is a dummy item and dummy description here... fghghgsfgg fghgh hghghgh sjhjsgdyf jhhsfdd hgfgdgf" .
