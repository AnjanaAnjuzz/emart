...
import 'package:emart_app/views/home_screen/componemts/feautured_button.dart';
             ...
             child: Column(
              ...
              20.heightBox,
                Row(
                  ...
                  icon: index==00?icTopCategories:index==1?icBrands:icTopSeller,
                ...
                20.heightBox,
                 ...
                 Align(
                    ...
                    child: feauturedCategories.text.color(darkFontGrey).size(18).fontFamily(semibold).make()),
                    20.heightBox,
              ...
              20.heightBox,
               GridView.builder(
                ...
                ).box.white.margin(const EdgeInsets.symmetric(horizontal: 4)).roundedSM.padding(EdgeInsets.all(12)).make();
